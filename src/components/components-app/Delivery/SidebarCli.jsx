  ...
  return (
    <div className="flex flex-col p-4 bg-[#F8EEE6] w-64 relative" style={{ height: 'calc(100vh - 80px)' }}>
      ...
      <div className="my-5 flex flex-col gap-5">
        <Link className="flex items-center gap-2 p-3 rounded-lg text-gray-500 hover:bg-[#e2c9ba] hover:text-black group" to="/Panel/LastPedido">
          <BiSolidDashboard className="text-lg" />
          <span className="group-hover:font-semibold">Ultimo Pedido</span>
        </Link>

        <Link className="flex items-center gap-2 p-3 rounded-lg text-gray-500 hover:bg-[#e2c9ba] hover:text-black group" to="/Panel/PedidoDelivery">
          <BiSolidBriefcase className="text-lg" />
          <span className="group-hover:font-semibold">Generar Pedido</span>
        </Link>

        <Link className="flex items-center gap-2 p-3 rounded-lg text-gray-500 hover:bg-[#e2c9ba] hover:text-black group" to="/Panel/HistorialDelivery">
          <BiSolidBriefcase className="text-lg" />
