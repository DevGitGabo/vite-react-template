...
const HistorialPedido = () => {
  ...
  const visibleColumns = ["Nombre", "Correo", "RUC", "Cantidad", "Pago"];
  ...
  useEffect(() => {
    ...
    axios
      .get("https://backendcasona-production.up.railway.app/waiter/getAll")
      .then((res) => {
        setRecords(res.data);
      });
  }, []);
            ...
            {records.map((d, i) => {
              ...
              return (
                <tr key={i} className="hover:bg-gray-200">
                  ...
                  <td className="text-center">{d.correo}</td>
